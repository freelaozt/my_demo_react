    ...
    tvInfoData.forEach(res => {
        layout = (
            res.resData.map(item => (
                ...
                <Col xs={18} sm={10} md={14} lg={16} xl={18} xxl={20}>
                    <div>
                        <h2>{item.title}</h2>
                        <span style={{ color: "gray" }}>{item.originaltitle}</span>
                        <p>{item.plot}</p>
                    </div>
...
export default tvInfoHeaderLay;